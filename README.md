...
nvcc -std=c++14 -O0 -g -o overlap_test test.cu -lmpi -lmpi_cxx -I/usr/lib/x86_64-linux-gnu/openmpi/include -I/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi  
gdb --args mpirun -np 8 --allow-run-as-root overlap_test
nsys profile mpirun -np 8 --allow-run-as-root overlap_test
